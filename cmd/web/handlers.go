...
import (
	...
	"github.com/empty-crayon/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This fied cannot be more than 100 characters long")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "email", "This field cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "The email must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be blank")
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	// first change the session id again
	err := app.sessionManager.RenewToken(r.Context())
	if err != nil {
		app.serverError(w, r, err)
		return
	...
	app.sessionManager.Put(r.Context(), "flash", "You've been sucessfully logged out!")
